...
const CabinetAffiliate = lazy(() => import('../pages/cabinetAffiliate/CabinetAffiliate'));
const CabinetHelp = lazy(() => import('../pages/cabinetHelp/CabinetHelp'));
const CabinetInvestments = lazy(() => import('../pages/cabinetInvestments/CabinetInvestments'));
const CabinetProfile = lazy(() => import('../pages/cabinetProfile/CabinetProfile'));
const CabinetPromotion = lazy(() => import('../pages/cabinetPromotion/CabinetPromotion'));
...
const CabinetRegistration = lazy(() => import('../pages/cabinetForms/CabinetRegistration'));
const CabinetRecovery = lazy(() => import('../pages/cabinetForms/CabinetRecovery'));
			...
			<Router>
				<Suspense fallback={<Spinner />}>
					<Routes>
						...
						<Route path='/signin' element={<CabinetSignin />} />
